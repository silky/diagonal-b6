...
var functionDocs = map[string]Doc{
	...
	"add-expression": Doc{Doc: "Add an expression feature with the given id, tags and expression.\n", ArgNames: []string{"id","tags","expresson"}},
	...
	"call": Doc{Doc: "", ArgNames: []string{"f","args"}},
	...
	"count-keys": Doc{Doc: "Return a collection of the number of occurances of each value in the given collection.\n", ArgNames: []string{"collection"}},
	...
	"count-valid-keys": Doc{Doc: "Return a collection of the number of occurances of each valid value in the given collection.\nInvalid values are not counted, but case the key to appear in the output.\n", ArgNames: []string{"collection"}},
	...
	"drop-invalid": Doc{Doc: "Return a collection with all the entries that contain an InvalidFeatureID as the value dropped.\n", ArgNames: []string{"collection"}},
	...
	"histogram-swatch-with-id": Doc{Doc: "Return a change that adds a histogram with only colour swatches for the given collection.\n", ArgNames: []string{"collection","id"}},
	"histogram-with-id": Doc{Doc: "Return a change that adds a histogram for the given collection with the given ID.\n", ArgNames: []string{"collection","id"}},
	...
	"sum": Doc{Doc: "Return the sum of all values in a given collection.\n", ArgNames: []string{"collection"}},
